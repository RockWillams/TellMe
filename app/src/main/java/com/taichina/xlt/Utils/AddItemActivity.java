...
public class AddItemActivity extends ActionBarActivity {
    ...
    List<Map<String,Object>> mListretrun = new ArrayList<Map<String, Object>>();
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(new myBaseAdapter(this, mList, R.layout.seatch_list_submit, new String[]{"drawable", "tv1", "tv2", "tv3", "tv4","tv5","et1"}
                , new int[]{R.id.imageView1, R.id.textView1, R.id.textView2, R.id.textView3, R.id.textView4, R.id.textView5,R.id.submit_text}));
